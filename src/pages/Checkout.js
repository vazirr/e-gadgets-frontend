...
import { selectCount, productSlice } from "../features/counter/counterSlice";
...
export default function Checkout() {
  ...
  const handleOrder = (e) => {
    const order = {
      ...
      paymentMethod,
      selectedAddress,
      status: "pending", //other status can be deleivered, received.
    };
      ...
      <div className="max-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
          ...
          <div className="lg:col-span-2">
            <div className="mx-auto mt-24 bg-white max-w-7xl px-2 sm:px-2 lg:px-4">
