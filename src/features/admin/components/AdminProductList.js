                  ...
                  <div className="lg:col-span-3">
                    <div>
                      <Link
                        ...
                        className="rounded-md mx-10 my-5 bg-green-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-green-500 focus-visible:"
                      >
                        Add New Product
                      </Link>
                    </div>
    ...
    <div className="flex items-center justify-between border-t border-gray-200 bg-white px-4 py-3 sm:px-6">
      ...
      <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
        ...
        <div>
          ...
          >
            <button
              onClick={() => goToPage(page - 1)} // Previous page button
              disabled={page === 1}
            ...
            <button
              onClick={() => goToPage(page + 1)} // Next page button
            ...
            <div>
              ...
              <div className="mt-5">
                <Link
                  ...
                  className="rounded-md my-5 bg-indigo-600 px-3 py-2 text-sm font-semibold text-white"
                >
                  Edit Product
                </Link>
              </div>
